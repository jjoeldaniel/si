...
This repository contains a simple C++ testing suite for working with **control flow**. 
## Instructions

1. Download the project files:

   ```bash
   mkdir flow && cd flow && curl --remote-name-all https://raw.githubusercontent.com/jjoeldaniel/si/main/120/10_2/{main.cpp,run.sh} 
   ```
