...
public:
  ...
  // Rule: Throw std::invalid_argument if mins < 0, secs < 0, or secs > 59
  ...
  // TODO 3: Implement operator+
  // Rule: Add minutes and seconds. Handle seconds overflow (e.g., 65s -> 1m 5s)
  TimeDuration operator+(const TimeDuration &other) {
    // Your code here
    // Hint: You can create a new object to return, like:
    // return TimeDuration(new_m, new_s);
    return TimeDuration(0, 0); // Placeholder
  }
};
