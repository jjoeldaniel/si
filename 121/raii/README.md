...
This repository contains a simple C++ testing suite for working with **RAII**.
## Instructions

1. Download the project files:

   ```bash
   mkdir raii && cd raii && curl --remote-name-all https://raw.githubusercontent.com/jjoeldaniel/si/main/121/raii/{main.cpp,run.sh} 
   ```
