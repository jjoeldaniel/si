...
This repository contains a simple C++ testing suite for working with **inheritance**.
## Instructions

1. Download the project files:

   ```bash
   mkdir inheritance && cd inheritance && curl --remote-name-all https://raw.githubusercontent.com/jjoeldaniel/si/main/121/inheritance/{main.cpp,run.sh} 
   ```
