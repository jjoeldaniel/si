...
int main() {
    ...
    Student* student3_ptr = new Student("Charlie (Heap)", 103);
    ...
    // Write your code here:
    delete student3_ptr;
    student3_ptr = nullptr; // Also setting this to nullptr is good practice.


    std::cout << "\n--- Main function is ending... ---" << std::endl;
    
    // Watch the console: 'student1' (on the stack) will be
    // automatically destroyed here. 'student2' and 'student3'
    // (on the heap) should already be destroyed from 'delete'.
